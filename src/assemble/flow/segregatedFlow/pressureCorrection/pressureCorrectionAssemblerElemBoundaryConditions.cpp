// File       : pressureCorrectionAssemblerElemBoundaryConditions.cpp
...
void pressureCorrectionAssembler::assembleElemTermsBoundary_(
    const domain* domain,
    Context* ctx)
{
...
void pressureCorrectionAssembler::assembleElemTermsBoundarySymmetry_(
    const domain* domain,
...
void pressureCorrectionAssembler::assembleElemTermsBoundaryWallNoSlip_(
    const domain* domain,
    const boundary* boundary,
    Context* ctx)
{
...
void pressureCorrectionAssembler::
        ...
        Context* ctx)
{
    ...
    const auto& sideRhoSTKFieldRef =
        model_->rhoRef().sideFieldRef().stkFieldRef();
    const auto& reversalFlowFlagSTKFieldRef =
        model_->URef().reversalFlagRef().stkFieldRef();
...
void pressureCorrectionAssembler::assembleElemTermsBoundaryOutletOutflow_(
    const domain* domain,
    const boundary* boundary,
    Context* ctx)
{
...
void pressureCorrectionAssembler::assembleElemTermsBoundaryOpening_(
    const domain* domain,
    const boundary* boundary,
    Context* ctx)
{
