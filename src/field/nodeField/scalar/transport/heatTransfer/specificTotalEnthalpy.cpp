// File : specificTotalEnthalpy.cpp
...
specificTotalEnthalpy::specificTotalEnthalpy(realm* realmPtr,
...
void specificTotalEnthalpy::updateBoundarySideField(label iZone,
                                                    label iBoundary)
{
