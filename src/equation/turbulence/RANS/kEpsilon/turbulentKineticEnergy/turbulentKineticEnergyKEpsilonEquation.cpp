// File       : turbulentKineticEnergyKEpsilonEquation.cpp
...
turbulentKineticEnergyKEpsilonEquation::turbulentKineticEnergyKEpsilonEquation(
    realm* realm,
    kEpsilonModel* model)
...
void turbulentKineticEnergyKEpsilonEquation::setup()
{
                      ...
                      [this](const domain* domain, STKScalarField& Gamma)
    {
        ...
        const scalar sigmaK = model_->sigmaK();
        ...
        for (size_t ib = 0; ib < nodeBuckets.size(); ib++)
        {
            ...
            {
                Gammab[i] = mu[i] + mut[i] / sigmaK;
            }
        }
    });
}

void turbulentKineticEnergyKEpsilonEquation::initialize()
{
    turbulentKineticEnergyEquation::initialize();
}

void turbulentKineticEnergyKEpsilonEquation::postInitialize()
{
}

void turbulentKineticEnergyKEpsilonEquation::solve()
{
...
void turbulentKineticEnergyKEpsilonEquation::applyOverrides()
{
