...
# mu1/mu2=10/1, g=0.98, sigma=24.5.
# Converted to Euler-Euler form for OpenAccel validation.
mesh:
    file_path: mesh.e
...
simulation:
    ...
    solver:
        ...
        output_control:
            file_path: results_euler_euler.e
            output_frequency:
                option: time_interval
                time_interval: 0.05
            write_timestep_info: true
            output_fields: [velocity, pressure, volume_fraction.fluid2, body_forces]
    material_library:
    - name: fluid1
