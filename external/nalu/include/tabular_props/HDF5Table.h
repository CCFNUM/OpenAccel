...
public:
    ...
    /** Read HDF5Table from the specified HDF5 device, an already-specified
     * subtable.  This is also used to read Converter tables. */
...
private:
     ...
     *  so that they talk to each other properly and inputs to the HDF5Table
     * will be sent to the correct object. */
    ...
    // Scratch space for doing log scale conversions, etc. on the input
    // variables
