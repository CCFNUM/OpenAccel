...
public:
    ...
    void
    quad_shape_fcn(const int& npts, const double* par_coord, double* shape_fcn);
};
...
public:
    ...
    void
    gij(const double* coords, double* gupperij, double* gij, double* deriv);
...
private:
    void face_grad_op(const int face_ordinal,
                      const bool shifted,
                      SharedMemView<DoubleType**>& coords,
                      SharedMemView<DoubleType***>& gradop);
};
