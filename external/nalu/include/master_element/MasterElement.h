...
public:
    ...
    virtual void grad_op(SharedMemView<DoubleType**>& coords,
    ...
    virtual void shifted_grad_op(SharedMemView<DoubleType**>& coords,
                                 SharedMemView<DoubleType***>& gradop,
                                 SharedMemView<DoubleType***>& deriv)
    {
        throw std::runtime_error(
    ...
    virtual void face_grad_op(int face_ordinal,
                              SharedMemView<DoubleType**>& coords,
                              SharedMemView<DoubleType***>& gradop)
    {
        throw std::runtime_error(
            "face_grad_op using SharedMemView is not implemented");
    }

    virtual void shifted_face_grad_op(int face_ordinal,
                                      SharedMemView<DoubleType**>& coords,
                                      SharedMemView<DoubleType***>& gradop)
    {
        throw std::runtime_error(
            "shifted_face_grad_op using SharedMemView is not implemented");
    }

    virtual void grad_op_fem(SharedMemView<DoubleType**>& coords,
                             SharedMemView<DoubleType***>& gradop,
                             SharedMemView<DoubleType***>& deriv,
    ...
    virtual void shifted_grad_op_fem(SharedMemView<DoubleType**>& coords,
                                     SharedMemView<DoubleType***>& gradop,
                                     SharedMemView<DoubleType***>& deriv,
                                     SharedMemView<DoubleType*>& det_j)
    {
    ...
    virtual void face_grad_op_fem(int face_ordinal,
                                  SharedMemView<DoubleType**>& coords,
                                  SharedMemView<DoubleType***>& gradop,
                                  SharedMemView<DoubleType*>& det_j)
    {
        throw std::runtime_error(
            "face_grad_op_fem using SharedMemView is not implemented");
    }
    ...
    virtual void determinant_fem(SharedMemView<DoubleType**>& coords,
                                 SharedMemView<DoubleType***>& deriv,
                                 SharedMemView<DoubleType*>& det_j)
    {
        throw std::runtime_error(
            "determinant_fem using SharedMemView is not implemented");
    }

    virtual void normal_fem(SharedMemView<DoubleType**>& coords,
                            SharedMemView<DoubleType***>& deriv,
                            SharedMemView<DoubleType**>& normal)
    {
        throw std::runtime_error(
            "normal_fem using SharedMemView is not implemented");
    }

    virtual void gij(SharedMemView<DoubleType**>& coords,
    ...
    virtual void determinant(const int nelem,
                             const double* coords,
                             double* volume,
                             double* error)
    {
    ...
    virtual void grad_op(const int nelem,
                         const double* coords,
                         double* gradop,
                         double* deriv,
                         double* det_j,
    ...
    virtual void shifted_grad_op(const int nelem,
                                 const double* coords,
                                 double* gradop,
                                 double* deriv,
                                 double* det_j,
    ...
    virtual void face_grad_op(const int nelem,
                              ...
                              double* error)
    {
        throw std::runtime_error("face_grad_op not implemented; avoid this "
                                 "element type at open bcs, walls and symms");
    }

    virtual void shifted_face_grad_op(const int nelem,
                                      const int face_ordinal,
                                      const double* coords,
                                      double* gradop,
                                      double* det_j,
    ...
    virtual double isInElement(const double* elemNodalCoord,
    ...
    virtual void interpolatePoint(const int& nComp,
    ...
    virtual void general_face_grad_op(const int face_ordinal,
                                      const double* isoParCoord,
                                      const double* coords,
                                      double* gradop,
                                      double* det_j,
    ...
    virtual void general_normal(const double* isoParCoord,
                                const double* coords,
                                double* normal)
    {
    ...
    virtual void sidePcoords_to_elemPcoords(const int& side_ordinal,
                                            const int& npoints,
    ...
    double isoparametric_mapping(const double b,
                                 const double a,
...
protected:
    ...
    double shifted_gauss_point_location(int nodeOrdinal,
...
private:
    ...
    void quad9_shape_deriv(int npts,
                           const double* par_coord,
                           double* shape_fcn) const;
};
...
public:
    ...
    void general_normal(const double* isoParCoord,
                        const double* coords,
                        double* normal);
};
...
private:
    void area_vector(const double* POINTER_RESTRICT coords,
                     const double s,
