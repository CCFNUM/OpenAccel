...
public:
    ...
    void determinant_fem(SharedMemView<DoubleType**>& coords,
                         SharedMemView<DoubleType***>& deriv,
                         SharedMemView<DoubleType*>& det_j) final;

    void grad_op_fem(SharedMemView<DoubleType**>& coords,
                     SharedMemView<DoubleType***>& gradop,
                     SharedMemView<DoubleType***>& deriv,
                     SharedMemView<DoubleType*>& det_j) final;

    void shifted_grad_op_fem(SharedMemView<DoubleType**>& coords,
                             SharedMemView<DoubleType***>& gradop,
                             SharedMemView<DoubleType***>& deriv,
                             SharedMemView<DoubleType*>& det_j) final;

    void face_grad_op_fem(int face_ordinal,
    ...
    void interpolatePoint(const int& ncomp_field,
                          const double* isoParCoord,
                          const double* field,
                          double* result);
    ...
    void tet10_fem_shape_fcn(const int& numIp,
                             const double* isoParCoord,
    ...
    void
    tet10_derivative(const int& npts, const double* intgLoc, double* deriv);
