...
//=============================================================================
HDF5FilePtr::HDF5FilePtr(const std::string& fileName) : fileName_(fileName)
{
...
//-----------------------------------------------------------------------------
bool HDF5FilePtr::has_entry(const std::string& name) const
{
...
//-----------------------------------------------------------------------------
std::vector<std::string> HDF5FilePtr::property_names() const
{
    return propertyNames_;
}

//-----------------------------------------------------------------------------
void HDF5FilePtr::read_hdf5()
